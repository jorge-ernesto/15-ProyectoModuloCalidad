...
//      - Biomont UE Validacion LisCamEstCal (customscript_bio_ue_val_liscamestcal)
// - Registro:
//      - Lista de campos de estándares de calidad (customrecord_qm_standard_fields)
    ...
    function (N) {
        ...
        function beforeSubmit(context) {
            ...
            var searchObj = search.create({
                type: 'customrecord_qm_standard_fields',
                columns: [],
                filters: [
                    ['name', 'is', name],
                    'AND',
